...
public class Gato extends Animal {// subclase gato que hereda de animal
    ...
    public void mostrar() {
        ...
        System.out.println("Nº Chip: " + getChip());  // Usamos el get para mostrar el Chip
        System.out.println("Nombre: " + getNombre());  //Usamos el get para mostrar el nombre
        System.out.println("Edad: " + getEdad());  // Usamos el get para mostrar la edad
        System.out.println("Raza: " + getRaza());  // Usamos el get para mostrar la raza
        System.out.println("¿Es adoptado?: " + (isAdoptado() ? "Sí" : "No"));  // Usamos el get para mostrar si es adoptado o no
