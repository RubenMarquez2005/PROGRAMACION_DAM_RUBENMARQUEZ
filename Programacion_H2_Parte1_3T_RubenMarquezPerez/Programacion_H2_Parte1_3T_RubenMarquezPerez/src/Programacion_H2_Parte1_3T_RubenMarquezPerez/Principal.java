...
import java.sql.*; // para trabajar con SQL
...
public class Principal {
    ...
    // Función para que podamos ver las películas
    public static void mostrarPeliculas() {
        Connection conexion = Conexion.obtenerConexion(); // obtenemos la conexión
        if (conexion == null) {
        ...
        try {
            // Creamos una sentencia SQL con JOIN para ver películas + director
